...
public class PlayersListPointAdapterView extends ArrayAdapter<Player> {
	private ArrayList<Player> objects;
	
	public PlayersListPointAdapterView(Context context, int textViewResourceId, ArrayList<Player> objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		rating.setText(player.getPoints()+"");
